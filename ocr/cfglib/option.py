...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--exp_name', default="TD500", type=str,
                                 choices=['pre-training', "ArT", "MLT2017", "SGD", "tenocr_testing", "Adam"], help='Experiment name')
        ...
        self.parser.add_argument('--test_size', default=[0, 1024], type=int, nargs='+', help='test size')
        ...
        self.parser.add_argument('--model_root', default=None,   type=str, help='Path to deploy model')
